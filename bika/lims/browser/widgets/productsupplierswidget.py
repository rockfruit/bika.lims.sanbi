...
class ProductSuppliersView(BikaListingView):
    def __init__(self, context, request, field_value=None, allow_edit=False):
        ...
        self.field_value = field_value if field_value else []
...
class ProductSuppliersWidget(TypesWidget):
    ...
    _properties.update({
        'macro': "bika_widgets/productsupplierswidget",
    })
    ...
    def process_form(self, instance, field, form, empty_marker=None,
        ...
        """Take a list of UIDs from checkboxes with name='uids:list'."""
        value = form.get('uids', empty_marker)
